...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schedule_event', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['todo.Item'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'schedule.event': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['todo.Item']", 'null': 'True', 'blank': 'True'}),
